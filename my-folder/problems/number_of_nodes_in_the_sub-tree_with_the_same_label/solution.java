class Solution {
    ...
    private int[] helper(ArrayList<ArrayList<Integer>> graph, boolean[] isVisited, int[] result, char[] labels, int index){
        
        int[] frequency = new int[26];
        if(isVisited[index]) return frequency;
        ...
        result[index] = ++frequency[labels[index] - 'a'];
        return frequency;
    }
